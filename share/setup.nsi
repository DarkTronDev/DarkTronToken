...
!define URL http://www.darktrontoken.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/darktrontoken.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\darktrontoken-qt.exe
...
OutFile darktrontoken-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/darktrontoken-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/darktrontokend.exe
    ...
    #Delete /REBOOTOK $INSTDIR\darktrontoken.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\darktrontoken-qt.exe
...
Section -un.post UNSEC0001
    ...
    DeleteRegKey HKCR "darktrontoken"
