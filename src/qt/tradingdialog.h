...
private slots:
    ...
    void on_BuyDTT_clicked();
    void on_SellDTTBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputDTT_textChanged(const QString &arg1);
    ...
    QString BuyDTT(QString OrderType, double Quantity, double Rate);
    QString SellDTT(QString OrderType, double Quantity, double Rate);
